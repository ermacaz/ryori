  ...
  return(
    <Modal show={true} size="xl"  onHide={handleClose}>
      ...
      <Modal.Body className={'dark-primary'}>
        <Form>
          <RecipeForm recipe={localRecipe} setShowDialog={setShowEditRecipeDialog} setRecipe={setLocalRecipe} setAuthorized={setAuthorized} setPrimaryImage={setPrimaryImage}/>
