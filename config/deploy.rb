...
set :application_name, 'ryori'
set :domain, 'ermacaz.com'
set :deploy_to, '/var/www/ryori'
set :repository, 'git@github.com:ermacaz/ryori.git'
set :branch, 'main'
...
set :shared_files, fetch(:shared_files, []).push('config/database.yml', 'config/secrets.yml', 'app/javascript/constants/globals.js')
